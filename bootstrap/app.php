...
$app->bind('index',App\Http\Controllers\IndexController::class);
...
$app->afterResolving('index',function (){
    file_put_contents('index.resolved','Index Resolved'.PHP_EOL,FILE_APPEND);
});
